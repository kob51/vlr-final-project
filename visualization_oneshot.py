...
# USER INPUTS #####################################################################
start_frame = 0
end_frame = -1     # input -1 if you want to go to the end
opt_3d = 'save'   # 'save' or 'show' or 'skip'
print_filenames = True
every_n = 1

root_dir = "trained_on_full"  # "trained_on_full", "trained_on_xx"
pcl_type = "full"           # "full", "50", "75", etc

classes_list = np.array(["Van"])  # Truck, Car, Pedestrian
###############################################################################3
...
attempt = "attempt5"
pkl_path = "/home/mrsd2/Documents/vlr-project/oneshot_voxelrcnn/output/voxel_rcnn/voxel_rcnn_van/pkl_files/" + attempt + "/result.pkl"
save_path = "/home/mrsd2/Documents/vlr-project/oneshot_voxelrcnn/output/voxel_rcnn/voxel_rcnn_van/pkl_files/" + attempt + "/result.pkl"
